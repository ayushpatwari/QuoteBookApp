        ...
        ZStack{
            ...
            VStack (alignment: .leading) {
                ...
                VStack(alignment: .leading){
                    ...
                    TagView(tags: model.selectedTags)
                    HStack{
                ...
                if visibility {
                    Text("Note: This quote will be made public to everyone - it cannot be made private or deleted once published.")
                        .font(.footnote)
