...
struct EditQuoteView: View {
    ...
    init(quote: Quote){
        ...
        self._color = State(initialValue: quote.color)
                    ...
                    if words.count <= 3 && !isPublic {
                        ...
                        Button {
                            if !isPublic {
                                ...
                                model.updateData(quoteToUpdate: quote, newContent: content, newAuthor: author, newVisibility: visibility, newColor: color)
